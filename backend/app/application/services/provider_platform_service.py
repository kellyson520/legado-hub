...
class ProviderPlatformService:
    ...
    async def invoke_novel_chat(
        ...
        *,
        ...
        return await self._invoke_specialized(
            "novel_chat", "invoke_chat", owner_scope, model, payload, quota_scope
        )
    ...
    async def invoke_novel_extract(
        ...
        *,
        ...
        return await self._invoke_specialized(
            "novel_extract", "invoke_chat", owner_scope, model, payload, quota_scope
        )
    ...
    async def invoke_novel_summary(
        ...
        *,
        ...
        return await self._invoke_specialized(
            "novel_summary", "invoke_chat", owner_scope, model, payload, quota_scope
        )
    ...
    async def invoke_novel_embedding(
        ...
        *,
        ...
        return await self._invoke_specialized(
            "novel_embedding", "invoke_embedding", owner_scope, model, payload, quota_scope
        )
