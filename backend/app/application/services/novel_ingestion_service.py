...
from app.services.novel_ingestion.parsers import (
    NovelDocumentParser,
    ParsedChapter,
    ParsedNovelDocument,
)
from app.services.novel_ingestion.url_security import NovelUrlPolicy
...
class NovelIngestionService:
    ...
    async def save_progress(
        ...
        progress = NovelReadingProgress(
            ...
            font_size=max(10, min(48, int(preferences.get("font_size", 18)))),
        )
