...
class ProviderRegistry:
    ...
    def resolve_group(self, provider_group: str, capability: str | None = None) -> list[ProviderSelection]:
        ...
        if capability is not None:
            filtered = [
                ...
                if self._supports(selection.provider, capability)
            ]
            if filtered:
    ...
    @staticmethod
    def _supports(provider: ProviderAdapter, capability: str) -> bool:
