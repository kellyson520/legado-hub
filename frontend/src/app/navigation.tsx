...
export const navigationGroups: NavigationGroup[] = [
  ...
  { label: '运营', items: [{ label: '规则引擎', to: '/engine', icon: Gauge, permission: 'engine.test' }, { label: 'AI 对话', to: '/ai/workspace', icon: Bot, permission: 'ai.run' }, { label: 'AI 任务', to: '/ai/tasks', icon: Bot, permission: 'ai.run' }, { label: '翻译任务', to: '/translation/jobs', icon: FileText, permission: 'translation.run' }, { label: '小说任务', to: '/novel/tasks', icon: ClipboardList, permission: 'novel.manage' }] },
  ...
  { label: '管理', items: [{ label: '用户管理', to: '/admin/users', icon: Users, permission: 'users.read', adminOnly: true }, { label: 'API Key', to: '/admin/api-keys', icon: FileKey, permission: 'api_keys.read', adminOnly: true }, { label: '审计日志', to: '/admin/audit', icon: ShieldCheck, permission: 'system.audit.read', adminOnly: true }, { label: '系统设置', to: '/system/settings', icon: Settings, permission: 'system.settings.manage', adminOnly: true }] },
]
