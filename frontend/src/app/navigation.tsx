...
export const navigationGroups: NavigationGroup[] = [
  ...
  { label: '运营', items: [{ label: '规则引擎', to: '/engine', icon: Gauge, permission: 'engine.test' }, { label: 'AI 对话', to: '/ai/workspace', icon: Bot, permission: 'ai.run' }, { label: 'AI 任务', to: '/ai/tasks', icon: Bot, permission: 'ai.run' }, { label: '翻译任务', to: '/translation/jobs', icon: FileText, permission: 'translation.run' }, { label: '小说书架', to: '/novel/library', icon: BookOpen, permission: 'novel.manage' }, { label: '小说任务', to: '/novel/tasks', icon: ClipboardList, permission: 'novel.manage' }] },
