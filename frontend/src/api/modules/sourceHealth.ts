...
import type { PaginatedEnvelope, PaginatedQueryParams } from '@/api/types'
...
export async function listSourceHealth(params: SourceHealthListParams = {}): Promise<PaginatedEnvelope<SourceHealthRow>> {
