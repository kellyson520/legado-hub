        ...
        return (
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <p className="text-xs font-medium text-muted-foreground">run id</p>
            ...
            <div className="mt-6 rounded-md border border-primary/25 bg-accent/60 p-4">
              <p className="text-xs font-semibold text-primary">deployment decision</p>
              <p className="mt-3 text-sm text-foreground">
                {deployment ? `${deployment.action} -> ${deployment.status}` : 'waiting for deployment review'}
              </p>
            </div>
          </article>
        )
